...
while($row=mysqli_fetch_array($result,MYSQLI_ASSOC)){
  printf("<tr><td>&nbsp;%s</td><td>&nbsp;%s</td><td>&nbsp;%s</td><td>&nbsp;%s&nbsp;</td><td>&nbsp;%s&nbsp;</td><td>&nbsp;%s&nbsp;</td><td><a href='procesaactualiza.php?codigo=%d/'>AGREGAR AL CARRITO</a></td></tr>",$row["nombre"],$row["codigo"],$row["aplicacion"],$row["cantidad"],$row["uni"],$row["precio"],$row["codigo"]);
}
?>
            <thead class="u-black u-table-header u-table-header-1">
              <tr style="height: 21px;">
                ...
                <th class="u-border-1 u-border-black u-table-cell">AGREGAR </th>
              </tr>
            </thead>
            
          </table>
          <a href="/farma/carro.php" class="u-align-center u-border-none u-btn u-button-style u-palette-1-light-1 u-btn-1">VER CARRITO</a>
        </div>
      </div>
    </section>
    ...
    <footer class="u-align-center-md u-align-center-sm u-align-center-xs u-clearfix u-footer u-grey-80" id="sec-9346"><div class="u-clearfix u-sheet u-sheet-1">
        <a href="https://www.youtube.com/watch?v=p882FfaoIsw" class="u-image u-logo u-image-1" data-image-width="500" data-image-height="500">
