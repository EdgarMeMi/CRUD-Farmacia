...
while($row=mysqli_fetch_array($result,MYSQLI_ASSOC)){
  printf("<tr><td>&nbsp;%s</td><td>&nbsp;%s</td><td>&nbsp;%s</td><td>&nbsp;%s&nbsp;</td><td>&nbsp;%s&nbsp;</td><td>&nbsp;%s&nbsp;</td><td><a href='procesaactualiza.php?codigo=%d/'>MODIFICAR</a></td></tr>",$row["nombre"],$row["codigo"],$row["aplicacion"],$row["cantidad"],$row["uni"],$row["precio"],$row["codigo"]);
}
?>
            <thead class="u-black u-table-header u-table-header-1">
              <tr style="height: 21px;">
                ...
                <th class="u-border-1 u-border-black u-table-cell">MODIFICAR </th>
              </tr>
            </thead>
